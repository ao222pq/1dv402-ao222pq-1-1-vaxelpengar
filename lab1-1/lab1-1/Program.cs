            ...
            while (true)
            {
                try
                {
                    ...
                    if (subtotal < 0.5)
                    {
                        ...
                        Console.WriteLine("Summan är för låg, köpet kunde inte genomföras.");
                        Console.ResetColor();
                        endProgram = true;
                    }
                    break;
            ...
            if (endProgram == false)
            {
                while (true)
                {
                    try
                    {
                        ...
                        if (recieved < subtotal)
                        {
                            Console.BackgroundColor = ConsoleColor.Red;
                            Console.WriteLine("Mottaget belopp är lågre än totalsumman, köpet kunde inte genomföras.");
                            Console.ResetColor();
                            endProgram = true;
                        }
                        break;
